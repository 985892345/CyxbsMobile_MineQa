...
import kotlinx.android.synthetic.main.mine_dialog_exchange_product.*
...
class ProductExchangeDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (dialogRes) {
            R.layout.mine_dialog_exchange_product -> {
                mine_dialog_btn_negative.apply {
                    text = negativeString
                    onClick {
        ...
        mine_dialog_btn_positive.apply {
            text = positiveString
            onClick {
                onPositiveClick?.invoke()
            }
        }
        mine_tv_dialog_exchange_content.text = exchangeTips
    }
}
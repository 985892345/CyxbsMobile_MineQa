...
import com.mredrock.cyxbs.mine.page.store.viewmodel.EventRecordViewModel
import com.mredrock.cyxbs.mine.util.ui.ReusableRecyclerAdapter
...
class EventRecordFragment : BaseViewModelFragment<EventRecordViewModel>() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.mine_fragment_event_record, container, false)
    }

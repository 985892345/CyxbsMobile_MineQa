...
class ImageIndicatorView : View {
    ...
    private fun initPaints() {
        ...
        mIndicatorUnderPaint.color = ContextCompat.getColor(context, R.color.mine_store_image_indicator_under)
        mIndicatorUnderPaint.style = Paint.Style.FILL
        mIndicatorUnderPaint.isAntiAlias = true
        //进度条选中矩形画笔
        mIndicatorSelectPaint = Paint()
        mIndicatorSelectPaint.color = ContextCompat.getColor(context, R.color.mine_store_image_indicator_select)
